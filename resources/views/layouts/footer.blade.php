<footer class="">
    ...
    >
        <div class="p-5">
        <h3 class="font-bold text-xl text-green-600">Company Name</h3>
        </div>
        <div class="p-5">
        <div class="text-sm uppercase text-green-600 font-bold">
            Resources
        </div>
    ...
    >
        ...
        <a href="/#" class="w-6 mx-1">
            <svg
            class="fill-current cursor-pointer text-gray-500 hover:text-green-600"
            width="100%"
            height="100%"
            viewBox="0 0 24 24"
            version="1.1"
